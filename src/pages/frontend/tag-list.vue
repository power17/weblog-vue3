      ...
      <div class="col-span-4 md:col-span-3 mb-3">
        ...
        >
          ...
          <span
            ...
            class="inline-block px-3 py-1 rounded-full mb-1 cursor-pointer bg-green-100 text-green-800 text-xs font-medium mr-2 px-3 py-1 rounded-full hover:bg-green-200 hover:text-green-900 dark:bg-green-900 dark:text-green-300"
          >
            {{ tag.name }}
          </span>
        </div>
...
// 所有标签
const tags = ref<{ name: string; id: string }[]>([])
...
// 跳转标签文章列表页
const goTagArticleListPage = (id: string, name: string) => {
